...
public class JaqlTest {
    ...
    public void testRetrieveTemplates() throws Throwable {
        ...
        assertEquals("select * from templateQuery where name = 'nameValue'", jaql.getQueryByName("templateQuery", ImmutableMap.of("name", "nameValue")));
        ...
        String hl7ExtractedValue = jaql.getQueryByName("notAQueryButHl7ExtraUseCaseMultiline", ImmutableMap.of("LastName", "MyLastName", "FirstName", "MyFirstName", "Town", "MyTown", "ADTTYPE", "A04"));
