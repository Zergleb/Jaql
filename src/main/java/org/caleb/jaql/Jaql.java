...
public class Jaql {
    ...
    private final String replaceTagsStart;
    private final String replaceTagsEnd;

    private Map<String, String> queriesByName = new HashMap<>();

    public Jaql(InputStream resourceAsStream, String replaceTagsStart, String replaceTagsEnd) throws IOException {
        ...
        this.replaceTagsStart = replaceTagsStart;
